...
public class DragonFight {
	...
	int playerHealth=100;
		...
		int playerDamage=0;
	//i 6.  Delete the slashes at the beginning of the next line.  
...
dragonHealth-=dragonDamage;}
	...
	if (attack.equals("kick")) {
		...
		if (dragonHealth<=0){
			...
			JOptionPane.showMessageDialog(null, "The dragon is dead, and YOU just got a ton of gold!");}
	   //  15.  Else
		else {
